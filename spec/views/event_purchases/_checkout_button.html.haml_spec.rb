describe 'event_purchases/_checkout_button.html.haml' do
  let(:email) { 'EMAIL' }
  let(:name) { 'NAME' }
  ...
  before do
    ...
    render partial: 'event_purchases/checkout_button.html.haml', locals: {email: email, name: name, description: description, amount: amount}
  end
